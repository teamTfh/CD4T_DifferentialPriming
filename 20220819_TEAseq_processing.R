...
stim1.out <- Read10X(data.dir = "./20220801_Stim1/filtered_feature_bc_matrix")
stim2.out <- Read10X(data.dir = "./20220801_Stim2/filtered_feature_bc_matrix")
stim3.out <- Read10X(data.dir = "./20220801_Stim3/filtered_feature_bc_matrix")
unstim.out <- Read10X(data.dir = "./20220801_Unstim/filtered_feature_bc_matrix")
...
#adding ADT assay 
Stim1_adt_mat <- readRDS("./20220801_Stim1/Stim1_adt_count_mat.rds")
...
Stim2_adt_mat <- readRDS("./20220801_Stim2/Stim2_adt_count_mat.rds")
...
Stim3_adt_mat <- readRDS("./20220801_Stim3/Stim3_adt_count_mat.rds")
...
Unstim_adt_mat <- readRDS("./20220801_Unstim/Unstim_adt_count_mat.rds")
...
#Adding HTO 
Stim1_HTO_mat <- readRDS("./20220801_Stim1/Stim1_HTO_count_mat.rds")
...
Stim2_HTO_mat <- readRDS("./20220801_Stim2/Stim2_HTO_count_mat.rds")
...
Stim3_HTO_mat <- readRDS("./20220801_Stim3/Stim3_HTO_count_mat.rds")
...
Unstim_HTO_mat <- readRDS("./20220801_Unstim/Unstim_HTO_count_mat.rds")
...
fragpath.stim1 <-"./20220801_Stim1/atac_fragments.tsv.gz"
...
fragpath.stim2 <-"./20220801_Stim2/atac_fragments.tsv.gz"
...
fragpath.stim3 <-"./20220801_Stim3/atac_fragments.tsv.gz"
...
fragpath.unstim <-"./20220801_Unstim/atac_fragments.tsv.gz"
...
saveRDS(obj_stim1_1, file = "obj_stim1_1.rds")
saveRDS(obj_stim2_1, file = "obj_stim2_1.rds")
saveRDS(obj_stim3_1, file = "obj_stim3_1.rds")
saveRDS(obj_unstim_1, file = "obj_unstim_1.rds")

rm(stim1.out,stim2.out,stim3.out,unstim.out)
