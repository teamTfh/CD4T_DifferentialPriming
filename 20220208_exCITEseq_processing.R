...
setwd("~/OneDrive - NYU Langone Health/ECCITE-seq/Experiments/20220131_ECCITEseq_AIM_sgg")
#nFeature = number of unique genes detected in each cell 
#------------------------------------Initial QC-----------------------------------
...
#Keep HTO in ADT assay
#adt_assay_stim <- CreateAssayObject(counts = adt_stim)
#adt_assay_tetramer <- CreateAssayObject(counts = adt_tetramer)
#adt_assay_whole <- CreateAssayObject(counts = adt_whole)
#adt_assay_unstim <- CreateAssayObject(counts = adt_unstim)

#remove ADTs that were not put into the panel 
adt_assay_stim1 <- adt_stim1[setdiff(rownames(x = adt_stim1),c("Subject13_7moPV", "Subject13_1moPB", "Subject6_7moPV", "Subject6_1moPB", 
                                                               "Subject3_7moPV", "Subject3_1moPB","Subject5_7moPV", "Subject5_1moPB" )), ]
adt_assay_stim2 <- adt_stim2[setdiff(rownames(x = adt_stim2),c("Subject13_7moPV", "Subject13_1moPB", "Subject6_7moPV", "Subject6_1moPB", 
                                                               "Subject3_7moPV", "Subject3_1moPB","Subject5_7moPV", "Subject5_1moPB" )), ]
adt_assay_stim3 <- adt_stim3[setdiff(rownames(x = adt_stim3),c("Subject13_7moPV", "Subject13_1moPB", "Subject6_7moPV", "Subject6_1moPB", 
                                                               "Subject3_7moPV", "Subject3_1moPB","Subject5_7moPV", "Subject5_1moPB" )), ]
adt_assay_unstim <- adt_unstim[setdiff(rownames(x = adt_unstim),c("Subject13_7moPV", "Subject13_1moPB", "Subject6_7moPV", "Subject6_1moPB", 
                                                                  "Subject3_7moPV", "Subject3_1moPB","Subject5_7moPV", "Subject5_1moPB" )), ]
...
HTO_assay_stim1 <- adt_stim1[intersect(rownames(x = adt_stim1),c("Subject13_7moPV", "Subject13_1moPB", "Subject6_7moPV", "Subject6_1moPB", 
                                                                 "Subject3_7moPV", "Subject3_1moPB","Subject5_7moPV", "Subject5_1moPB")), ]
HTO_assay_stim2 <- adt_stim2[intersect(rownames(x = adt_stim2),c("Subject13_7moPV", "Subject13_1moPB", "Subject6_7moPV", "Subject6_1moPB", 
                                                                  "Subject3_7moPV", "Subject3_1moPB","Subject5_7moPV", "Subject5_1moPB" )), ]
HTO_assay_stim3 <- adt_stim3[intersect(rownames(x = adt_stim3),c("Subject13_7moPV", "Subject13_1moPB", "Subject6_7moPV", "Subject6_1moPB", 
                                                                  "Subject3_7moPV", "Subject3_1moPB","Subject5_7moPV", "Subject5_1moPB" )), ]
HTO_assay_unstim <- adt_unstim[intersect(rownames(x = adt_unstim),c("Subject13_7moPV", "Subject13_1moPB", "Subject6_7moPV", "Subject6_1moPB", 
                                                                     "Subject3_7moPV", "Subject3_1moPB","Subject5_7moPV", "Subject5_1moPB" )), ]
...
stim1 <- CalculateBarcodeInflections(stim1, group.column = 'orig.ident', barcode.column = "nCount_RNA", threshold.low = 21000, threshold.high = 29000)
...
stim2 <- CalculateBarcodeInflections(stim2, group.column = 'orig.ident', barcode.column = "nCount_RNA", threshold.low = 21000, threshold.high = 29000)
...
stim3 <- CalculateBarcodeInflections(stim3, group.column = 'orig.ident', barcode.column = "nCount_RNA", threshold.low = 45000, threshold.high = 55000)
s3_rna <- BarcodeInflectionsPlot(stim3) + scale_x_log10() +scale_y_log10()+theme_bw()
...
unstim <- CalculateBarcodeInflections(unstim, group.column = 'orig.ident', barcode.column = "nCount_RNA",threshold.low = 21000, threshold.high = 29000)
u_rna <- BarcodeInflectionsPlot(unstim)  
...
help(CalculateBarcodeInflections)
u_rna
u_adt
u_hto
...
cells_stim1 <- subset(x = stim1, subset = rank <= 25159)
cells_stim2 <- subset(x = stim2, subset = rank <= 27558)
cells_stim3 <- subset(x = stim3, subset = nCount_RNA >= 500) #based off of inflection point with CalculateBarcodeInflection...
cells_unstim <- subset(x = unstim, subset = rank <= 22878)

#-----------------------------------------demultiplex using HODemux--------------------------------------------------
...
cells_stim1$hash.ID <- factor(cells_stim1$hash.ID, levels = c("Negative", "Subject13-7moPV", "Subject13-1moPB", "Subject6-7moPV", "Subject6-1moPB", 
                                                              "Subject3-7moPV", "Subject3-1moPB","Subject5-7moPV", "Subject5-1moPB", "Doublet"))
# Group cells based on the max HTO signal
Idents(cells_stim1) <- "HTO_maxID"
RidgePlot(cells_stim1, assay = "HTO", features = rownames(cells_stim1[["HTO"]])[1:8], ncol = 8)
s <- FeatureScatter(cells_stim1, feature1 = "Subject6-7moPV", feature2 = "Subject6-1moPB", group.by="hash.ID") + labs(title = "stim") + NoLegend()
...
cells_stim2$hash.ID <- factor(cells_stim2$hash.ID, levels = c("Negative", "Subject13-7moPV", "Subject13-1moPB", "Subject6-7moPV", "Subject6-1moPB", 
                                                              "Subject3-7moPV", "Subject3-1moPB","Subject5-7moPV", "Subject5-1moPB", "Doublet"))
# Group cells based on the max HTO signal
Idents(cells_stim2) <- "HTO_maxID"
RidgePlot(cells_stim2, assay = "HTO", features = rownames(cells_stim2[["HTO"]])[1:8], ncol = 8)
t <- FeatureScatter(cells_stim2, feature1 = "Subject6-7moPV", feature2 = "Subject6-1moPB", group.by="hash.ID") + labs(title = "tetramer") + theme(legend.position="bottom")
...
cells_stim3$hash.ID <- factor(cells_stim3$hash.ID, levels = c("Negative", "Subject13-7moPV", "Subject13-1moPB", "Subject6-7moPV", "Subject6-1moPB", 
                                                              "Subject3-7moPV", "Subject3-1moPB","Subject5-7moPV", "Subject5-1moPB", "Doublet"))
# Group cells based on the max HTO signal
Idents(cells_stim3) <- "HTO_maxID"
RidgePlot(cells_stim3, assay = "HTO", features = rownames(cells_stim3[["HTO"]])[1:8], ncol = 8)
w <- FeatureScatter(cells_stim3, feature1 = "Subject6-7moPV", feature2 = "Subject6-1moPB", group.by="hash.ID") + labs(title = "whole") + NoLegend()
...
cells_unstim$hash.ID <- factor(cells_unstim$hash.ID, levels = c("Negative", "Subject13-7moPV", "Subject13-1moPB", "Subject6-7moPV", "Subject6-1moPB", 
                                                                "Subject3-7moPV", "Subject3-1moPB","Subject5-7moPV", "Subject5-1moPB", "Doublet"))
# Group cells based on the max HTO signal
Idents(cells_unstim) <- "HTO_maxID"
RidgePlot(cells_unstim, assay = "HTO", features = rownames(cells_unstim[["HTO"]])[1:8], ncol = 8)
u <- FeatureScatter(cells_unstim, feature1 ="Subject6-7moPV", feature2 = "Subject6-1moPB", group.by="hash.ID") + labs(title = "unstim") + NoLegend()
...
cells_stim1 <- subset(cells_stim1, subset = nCount_HTO >= 6)
cells_stim2 <- subset(cells_stim2, subset = nCount_HTO >= 6)
cells_stim3 <- subset(cells_stim3, subset= nCount_HTO >= 6)
cells_unstim <- subset(cells_unstim, subset = nCount_HTO >= 6)
...
whole_hash <- cells_stim3@meta.data %>% 
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) +
  theme(plot.title = element_text(hjust=0.5, face="bold")) +
  ggtitle("Stim3 NCells")+ ylim(c(0,50000)) +
  geom_text(aes(label = ..count..), stat = "count", vjust = -1.5)
...
FeatureScatter(object = cells_stim1, feature1 = "nCount_RNA", feature2 = "nFeature_RNA", group.by = "scDblFinder.class") +  geom_hline(yintercept = c(400, 7000)) + labs(title = "stim")

#Do doublets have higher nCount and nFeature and negatives have lower nCount and nFeature?
Idents(cells_stim1) <- "scDblFinder.class"
...
DimPlot(cells_stim1, label = TRUE, group.by = "has.ID", pt.size = 1)
s1 <- DimPlot(cells_stim1, label = TRUE)
...
FeatureScatter(object = cells_stim2, feature1 = "nCount_RNA", feature2 = "nFeature_RNA", group.by = "hash.ID") +  geom_hline(yintercept = c(400, 7000)) + labs(title = "stim2")
...
s3 <- DimPlot(cells_stim3, label = FALSE, group.by = "scDblFinder.class") 
...
FeatureScatter(object = cells_unstim, feature1 = "nCount_RNA", feature2 = "nFeature_RNA", group.by = "scDblFinder.class") +  geom_hline(yintercept = c(200, 4500)) + labs(title = "unstim")
...
cells_stim1$HTO_maxID <- factor(cells_stim1$HTO_maxID, levels = c("Subject13-7moPV", "Subject13-1moPB", "Subject6-7moPV", "Subject6-1moPB", 
                                                                  "Subject3-7moPV", "Subject3-1moPB","Subject5-7moPV", "Subject5-1moPB"))
cells_stim2$HTO_maxID <- factor(cells_stim2$HTO_maxID, levels=c("Subject13-7moPV", "Subject13-1moPB", "Subject6-7moPV", "Subject6-1moPB", 
                                                                "Subject3-7moPV", "Subject3-1moPB","Subject5-7moPV", "Subject5-1moPB"))
cells_stim3$HTO_maxID <- factor(cells_stim3$HTO_maxID, levels=c("Subject13-7moPV", "Subject13-1moPB", "Subject6-7moPV", "Subject6-1moPB", 
                                                                "Subject3-7moPV", "Subject3-1moPB","Subject5-7moPV", "Subject5-1moPB"))
cells_unstim$HTO_maxID <- factor(cells_unstim$HTO_maxID, levels=c("Subject13-7moPV", "Subject13-1moPB", "Subject6-7moPV", "Subject6-1moPB", 
                                                                  "Subject3-7moPV", "Subject3-1moPB","Subject5-7moPV", "Subject5-1moPB"))
...
unstim_hash <-cells_unstim@meta.data %>% 
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) +
  theme(plot.title = element_text(hjust=0.5, face="bold")) +
  ggtitle(" Unstim NCells")+ ylim(c(0,22000)) +
  geom_text(aes(label = ..count..), stat = "count", vjust = -1.5)
...
whole_hash <-cells_stim3@meta.data %>% 
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) +
  theme(plot.title = element_text(hjust=0.5, face="bold")) +
  ggtitle("Whole PBMCs NCells") + ylim(c(0,50000))
...
stim_hash <- FeatureScatter(cells_stim1, feature1 = "CD3E", feature2 = "CD19", group.by = "stim_ID1") + NoLegend() + labs(title="stim1") #+ geom_vline(xintercept = 0.75) +  geom_hline(yintercept = 0.75)
tet_hash <- FeatureScatter(cells_stim2, feature1 = "CD3E", feature2 = "CD19", group.by = "stim_ID2") + NoLegend() + labs(title="stim2") #+geom_vline(xintercept = 0.75)+ geom_hline(yintercept = 0.75)
whole_hash <- FeatureScatter(cells_stim3, feature1 = "CD3E", feature2 = "CD19", group.by = "stim_ID3") + NoLegend() + labs(title="stim3") #+geom_vline(xintercept = 0.75)+ geom_hline(yintercept = 0.75)
unstim_hash <- FeatureScatter(cells_unstim, feature1 = "CD3E", feature2 = "CD19", group.by = "unstim_ID") + labs(title="unstim")# + NoLegend() #+geom_vline(xintercept = 0.75)+ geom_hline(yintercept = 0.75)
...
DimPlot(stim2_singlet, label = FALSE)

#subset singlets round 2 by excluding cells that are double positive for CD19 and CD3E genes 
stim_hash <- FeatureScatter(stim1_singlet, feature1 = "CD3E", feature2 = "CD19", group.by = "HTO_maxID") + geom_vline(xintercept = 0.1) +  geom_hline(yintercept = 0.1) + labs(title = "stim1") + NoLegend()
tet_hash <- FeatureScatter(stim2_singlet, feature1 = "CD3E", feature2 = "CD19", group.by = "HTO_maxID") +geom_vline(xintercept = 0.1)+ geom_hline(yintercept = 0.1) + labs(title = "stim2")+ NoLegend()
whole_hash <- FeatureScatter(stim3_singlet, feature1 = "CD3E", feature2 = "CD19", group.by = "HTO_maxID") +geom_vline(xintercept = 0.1)+ geom_hline(yintercept = 0.1)+ labs(title = "whole")+ NoLegend()
unstim_hash <- FeatureScatter(uns_singlet, feature1 = "CD3E", feature2 = "CD19", group.by = "HTO_maxID")+geom_vline(xintercept = 0.1)+ geom_hline(yintercept = 0.1) + labs(title = "unstim")
...
stim1_singlet.2$HTO_maxID <-  gsub('Subject3-1moPB', 'Subject3-1moPB', stim1_singlet.2$HTO_maxID)
...
stim1_singlet.2@meta.data <- stim1_singlet.2@meta.data  %>%
  mutate(PriorCOVID = case_when(
    ...
    endsWith(subject, "Subject3")  ~ "no",
    endsWith(subject, "Subject5")  ~ "no",
    endsWith(subject, "Subject13") ~ "yes"
  ))
...
stim1_singlet.2$timepoint <- factor(stim1_singlet.2$timepoint, levels=c("7moPostVax","1moPostBoost"))
View(stim1_singlet.2@meta.data)

stim2_singlet.2$HTO_maxID <-  gsub('Subject3-1moPB', 'Subject3-1moPB', stim2_singlet.2$HTO_maxID)
...
stim2_singlet.2$timepoint <- factor(stim2_singlet.2$timepoint, levels=c("7moPostVax","1moPostBoost"))

stim3_singlet.2$HTO_maxID <-  gsub('Subject3-1moPB', 'Subject3-1moPB', stim3_singlet.2$HTO_maxID)
...
stim3_singlet.2$timepoint <- factor(stim3_singlet.2$timepoint, levels=c("7moPostVax","1moPostBoost"))

uns_singlet.2$HTO_maxID <-  gsub('Subject3-1moPB', 'Subject3-1moPB', uns_singlet.2$HTO_maxID)
...
saveRDS(stim1_singlet.2, file = "20220131_stim1.rds")
saveRDS(stim2_singlet.2, file = "20220131_stim2.rds")

saveRDS(uns_singlet.2, file = "20220131_unstim.rds")
